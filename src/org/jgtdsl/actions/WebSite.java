...
responseHtml+="<div id='div__3' style=''><table width='1000px'  id='rounded-corner'>"+
					...
					responseHtml+="<div id=''>"+
							"<table width='1000px' border='0' id=''>"+
								"<tbody>"+
									"<tr>"+
									   "<td align=center colspan=7><br/><a class='btn btn-primary' href='http://103.48.17.216:8080/JGTDSL_WEB/clearnessCertificateInfo.action?area=19&download_type=individual_wise&customer_id="+customer_id+"&report_type=DC&collection_month=12&calender_year="+(year-1)+"&officer_name=Website&officer_desig=JGTDSL'>Download Clearance Certificate</a></td>"+
									"</tr>"+			
								"</tbody>"+
							"</table>"+
						"</div>";
